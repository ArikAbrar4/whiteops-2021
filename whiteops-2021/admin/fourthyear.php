...
<?php
  ...
  <script>
	function delCourse(time)
	{
		...
		{
		window.location.href='fourthdelete.php?time='+time;
		}
	}
</script>
...
<table class="table table-bordered table-striped table-hover">
    ...
    <tr>
	<td colspan="12"><a href="fourthyearadd.php?option=first" class="btn btn-default" style="color:black">Add New Time Slot</a></td>
	</tr>
...
$time=$_GET['fourthyearcourse'];
$sql=mysqli_query($con,"select * from fourthyearcourse");
...
<tr style="color:white;">
		...
		<td><a href="fourthyearscedule.php?option=fourthyearscedule&time=<?php echo $time; ?>"><i class="far fa-edit" style="color:#ffbb33; margin-left:15px;"></i></a></td>
