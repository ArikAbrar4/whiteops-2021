<?php 
  ...
  $sql= $con->query("INSERT INTO fourthyearcourse (time,course_o1,course_o2,course_o3,course_o4,course_o5,course_o6,course_o7,course_o8,course_o9) values('{$time}', '{$course_o1}', '{$course_o2}', '{$course_o3}', '{$course_o4}', '{$course_o5}', '{$course_o6}', '{$course_o7}', '{$course_o8}', '{$course_o9}')");
  header('location:fourth.php?option=fourthyear');
  }
          ...
          <div class="row">
            <div class="col-md-6 d-flex justify-content-start">
              ...
              <div class="footer-copyright text-center bg-transparent">
                ...
                <a href="firstyear.php" style="color:white"><b>/ Class Schedular</b></a>&ensp;
              </div>
            </div>
          </div>
        </div>
