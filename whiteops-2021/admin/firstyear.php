...
<?php
  ...
  <script>
	function delCourse(time)
	{
		...
		{
		window.location.href='firstdelete.php?time='+time;
		}
	}
</script>
...
<table class="table table-bordered table-striped table-hover">
    ...
    <tr>
	<td colspan="12"><a href="firstyearadd.php?option=first" class="btn btn-default" style="color:black">Add New Time Slot</a></td>
	</tr>
...
$time=$_GET['firstyearcourse'];
$sql=mysqli_query($con,"select * from firstyearcourse");
...
<tr style="color:white;">
		...
		<td><a href="firstyearscedule.php?option=firstyearscedule&time=<?php echo $time; ?>"><i class="far fa-edit" style="color:#ffbb33; margin-left:15px;"></i></a></td>
