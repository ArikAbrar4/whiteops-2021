...
if(isset($update))
{
mysqli_query($con,"update fourthyearcourse set course_o1='$course_o1',course_o2='$course_o2',course_o3='$course_o3' ,course_o4='$course_o4' ,course_o5='$course_o5' ,course_o6='$course_o6' ,course_o7='$course_o7' ,course_o8='$course_o8' ,course_o9='$course_o9' where time='$time' ");
header('location:fourthyear.php?option=fourth');
}
?>
<!DOCTYPE html>
<html lang="en">
