<?php 
  ...
  $sql= $con->query("INSERT INTO firstyearcourse (time,course_o1,course_o2,course_o3,course_o4,course_o5,course_o6,course_o7,course_o8,course_o9) values('{$time}', '{$course_o1}', '{$course_o2}', '{$course_o3}', '{$course_o4}', '{$course_o5}', '{$course_o6}', '{$course_o7}', '{$course_o8}', '{$course_o9}')");
  header('location:firstyear.php?option=firstyear');
  }
