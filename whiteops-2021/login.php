...
if(isset($login))
{
  ...
  {
  $sql=mysqli_query($con,"select * from create_account where utmid='$utmid' && password='$pass' ");
    if(mysqli_num_rows($sql))
    {
    $_SESSION['create_account_logged_in']=$utmid;
    header('location:dashboard.php');
    }
    else
    {
...
<form class="p-5">
    ...
    <input style="background-color: #54002a !important;" type="submit" value="Login" name="login" class="btn btn-info btn-block my-4 animated fadeIn slower"required>
</form>
<img src="maps/ad.gif" alt="Girl in a jacket" width="500" height="600">
</div>
</div>
